...
const sortByChildren = (charArray) => {
  // Solution code here...
  charArray.sort((a, b) => {(a.children > b.children
    ? 1
    : -1
...
const citiesAtoJ = (arr) => {
  // Solution code here...
  const newArr = /(^[A-J])/;
  // return newArr.test(arr);
  return arr.filter(city => newArr.test(city));
};
