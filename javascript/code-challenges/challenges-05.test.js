...
const toLastNames = people => {
  // Solution code here...
  let newArr = people.map(people => `${people.firstName} ${people.lastName}`);
  return newArr;
};
...
const addPurchases = (arr) => {
  ...
  return arr.reduce((previousValue, currentValue)=>{
    const updatedValue = previousValue + currentValue.purchasePrice;
    return updatedValue;
  }, 0);

  // const sum = arr.reduce(function (item, purchasePrice) {
  //   return addPurchases.item + addPurchases.purchasePrice;
  // });
  // return sum;
};
...
const returnNames = (arr) => {
  ...
  return arr.reduce((array, currentValue)=>{
    // const names = array + `${currentValue.name}`;
...
const reversedString = (str) => {
  ...
  //   const reversedString = currentValue + previousValue;
  //   return reversedString;
  // }, '');
  const reversedString = str.split('').reduce((previousValue, currentValue)=> {
